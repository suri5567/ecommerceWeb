...
// 				<div>
// 					<img src="https://seeklogo.com/images/F/fashion-shop-clothes-hanger-logo-C4A9A1FA8C-seeklogo.com.png" style={{ width: "80px", height: "70px", cursor:"pointer" }} onClick={handleHomePage} />
// 				</div>
...
// 							}
// 							alt=""
// 							style={{ marginRight: "15px" }} onClick={handleFunck} />
// 					{/* </Link> */}
// 					{userInfo && (
...
const Header = () => {
	...
	const isLoggedIn = userInfo !== null; // Check if user is logged in
				...
				<div className="flex items-center gap-8" style={{ color: "black" }}>
					...
					{/* <Link to="/"> */}
						<img
							...
							alt=""
							style={{ marginRight: "15px", cursor:"pointer" }} onClick={handleLoginPage} />
					{/* </Link> */}
					{userInfo && (
						<p className="text-base font-titleFont font-semibold underline underline-offset-2" style={{ paddingRight: "35px" }}>
							{userInfo.name}
